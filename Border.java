        ...
        if (t % 10 == 0 && GameStats.deathmatchCountDown == -1 && GameStats.gameEndTime == -1) {
            for (Player player: Bukkit.getServer().getOnlinePlayers()) {
                if ((w.getWorldBorder().getSize() / 2) - Math.abs(player.getLocation().getX()) + 4 < 30 &&
                    ...
                    player.playSound(player.getLocation(), Sound.PORTAL, (float)Math.abs(1 / (((Math.abs(player.getLocation().getX())) + 15) - (w.getWorldBorder().getSize()) / 2 + 4)), 2f);
            ...
            for (Player player: Bukkit.getServer().getOnlinePlayers()) {
                if ((w.getWorldBorder().getSize() / 2 - 25) - Math.abs(player.getLocation().getZ()) < 30 &&
                        (w.getWorldBorder().getSize() / 2 - 25) - Math.abs(player.getLocation().getZ()) > 15) {
                    ...
                    System.out.println((float)Math.abs(1 / (((Math.abs(player.getLocation().getZ())) + 15) - (w.getWorldBorder().getSize()) / 2)));
                    //System.out.println();
                } else if ((w.getWorldBorder().getSize() / 2 - 25) - Math.abs(player.getLocation().getZ()) <= 15) {
                    player.playSound(player.getLocation(), Sound.PORTAL, 1, 2f);
                }
